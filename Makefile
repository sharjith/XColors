#############################################################################
# Makefile for building: XColors
# Generated by qmake (3.1) (Qt 5.15.12)
# Project:  XColors.pro
# Template: app
# Command: /usr/lib64/qt5/bin/qmake -o Makefile XColors.pro -spec linux-g++
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = XColors1.0.0
DISTDIR = /srv/data/work/progs/Qt5/XColors/.tmp/XColors1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
...
DIST          = /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		...
		XColors.pro xcolors.h \
		rgb.h main.cpp \
		xcolors.cpp
QMAKE_TARGET  = XColors
DESTDIR       = 
TARGET        = XColors
...
XColors: ui_xcolors.h $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: XColors.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
		/usr/lib64/qt5/mkspecs/common/unix.conf \
		/usr/lib64/qt5/mkspecs/common/linux.conf \
		/usr/lib64/qt5/mkspecs/common/sanitize.conf \
		/usr/lib64/qt5/mkspecs/common/gcc-base.conf \
		...
		/usr/lib64/qt5/mkspecs/features/lex.prf \
		XColors.pro
	$(QMAKE) -o Makefile XColors.pro -spec linux-g++
...
distdir: FORCE
	...
	$(COPY_FILE) --parents xcolors.h rgb.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp xcolors.cpp $(DISTDIR)/
	$(COPY_FILE) --parents xcolors.ui $(DISTDIR)/
...
compiler_moc_header_make_all: moc_xcolors.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_xcolors.cpp
moc_xcolors.cpp: xcolors.h \
		moc_predefs.h \
		/usr/lib64/qt5/bin/moc
	/usr/lib64/qt5/bin/moc $(DEFINES) --include /srv/data/work/progs/Qt5/XColors/moc_predefs.h -I/usr/lib64/qt5/mkspecs/linux-g++ -I/srv/data/work/progs/Qt5/XColors -I/usr/include/qt5 -I/usr/include/qt5/QtWidgets -I/usr/include/qt5/QtGui -I/usr/include/qt5/QtCore -I/usr/include/c++/13 -I/usr/include/c++/13/x86_64-suse-linux -I/usr/include/c++/13/backward -I/usr/lib64/gcc/x86_64-suse-linux/13/include -I/usr/local/include -I/usr/lib64/gcc/x86_64-suse-linux/13/include-fixed -I/usr/x86_64-suse-linux/include -I/usr/include xcolors.h -o moc_xcolors.cpp

compiler_moc_objc_header_make_all:
compiler_moc_objc_header_clean:
compiler_moc_source_make_all:
compiler_moc_source_clean:
compiler_uic_make_all: ui_xcolors.h
compiler_uic_clean:
	-$(DEL_FILE) ui_xcolors.h
ui_xcolors.h: xcolors.ui \
		/usr/lib64/qt5/bin/uic
	/usr/lib64/qt5/bin/uic xcolors.ui -o ui_xcolors.h
...
main.o: main.cpp xcolors.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

xcolors.o: xcolors.cpp xcolors.h \
		ui_xcolors.h \
		rgb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o xcolors.o xcolors.cpp

moc_xcolors.o: moc_xcolors.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o moc_xcolors.o moc_xcolors.cpp
